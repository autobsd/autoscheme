...
return_value = autoscheme_eval(cons(mk_symbol("define"),cons(mk_symbol("with-exception-handler"),cons(cons(mk_syntax(LOC_MACRO,"macro"),cons(cons(mk_symbol("handler-code"),cons(mk_symbol("thunk-code"),NIL)),cons(cons(mk_symbol("let*"),cons(cons(cons(mk_symbol("eval"),cons(mk_operation(LOC_PEVAL,&NIL),NIL)),cons(cons(mk_symbol("handler"),cons(cons(mk_symbol("eval"),cons(mk_symbol("handler-code"),cons(cons(mk_symbol("expansion-environment"),NIL),NIL))),NIL)),cons(cons(mk_symbol("thunk"),cons(cons(mk_symbol("eval"),cons(mk_symbol("thunk-code"),cons(cons(mk_symbol("expansion-environment"),NIL),NIL))),NIL)),cons(cons(mk_symbol("current-exception-handlers"),cons(mk_operation(LOC_CURR_XHANDS,&NIL),NIL)),NIL)))),cons(cons(mk_symbol("parameterize"),cons(cons(cons(mk_symbol("current-exception-handlers"),cons(cons(mk_symbol("cons"),cons(mk_symbol("handler"),cons(cons(mk_symbol("current-exception-handlers"),NIL),NIL))),NIL)),NIL),cons(cons(mk_symbol("thunk"),NIL),NIL))),NIL))),NIL))),NIL))), environment);
return return_value;
}
