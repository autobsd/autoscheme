...
/* ************************ */
    ...
    /* scheme_register_syntax(OP_MACRO, "macro", environment); */
...
return_value = autoscheme_eval(T, environment);
return_value = autoscheme_eval(T, environment);
return_value = autoscheme_eval(cons(mk_symbol("define"),cons(mk_symbol("write-simple"),cons(mk_proc(OP_WRITE,&NIL),NIL))), environment);
