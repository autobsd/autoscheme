...
return_value = autoscheme_eval(cons(mk_symbol("define"),cons(mk_symbol("program-version"),cons(cons(mk_symbol("begin"),cons(mk_string("0.151.0 (rev 1634536861)"),NIL)),NIL))), environment);
