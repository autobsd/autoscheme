...
int LOAD_MODULE__auto_scheme_write(pointer environment)
{
autoscheme_eval(cons(mk_symbol("begin"),cons(cons(mk_symbol("begin"),cons(cons(mk_symbol("define-library"),cons(cons(mk_symbol("auto"),cons(mk_symbol("scheme"),cons(mk_symbol("write"),NIL))),cons(cons(mk_symbol("import"),cons(cons(mk_symbol("only"),cons(cons(mk_symbol("auto"),cons(mk_symbol("scheme"),NIL)),cons(mk_symbol("display"),cons(mk_symbol("write"),cons(mk_symbol("begin"),NIL))))),NIL)),cons(cons(mk_symbol("export"),cons(mk_symbol("display"),cons(mk_symbol("write"),NIL))),NIL)))),NIL)),NIL)),environment);
return 0;
}
