...
int main( int argc, char **argv )
{
    ...
    LOAD_MODULE__auto_scheme_sort(global_env);
...
autoscheme_eval(cons(mk_symbol("define"),cons(mk_symbol("program-version"),cons(cons(mk_syntax(LOC_BEGIN,"begin"),cons(mk_string("0.206.0 (rev 1637399278)"),NIL)),NIL))), environment);
