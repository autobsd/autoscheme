...
autoscheme_eval(cons(mk_symbol("define"),cons(mk_symbol("program-version"),cons(cons(mk_syntax(LOC_BEGIN,"begin"),cons(mk_string("0.185.0 (rev 1635566042)"),NIL)),NIL))), environment);
